...
export function StaffManagement() {
  ...
  const fetchStaff = async () => {
    try {
      const response = await fetch(
        "https://assettone-rental-management.onrender.com/api/v1/staff/",
        {
          headers: {
  ...
  const handleUpdateStaff = async () => {
    ...
    try {
      const response = await fetch(
        `https://assettone-rental-management.onrender.com/api/v1/staff/${selectedStaff.id}/`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleDeleteStaff = async (id: string) => {
    try {
      const response = await fetch(
        `https://assettone-rental-management.onrender.com/api/v1/staff/${id}/`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${localStorage.getItem("accessToken")}`,
